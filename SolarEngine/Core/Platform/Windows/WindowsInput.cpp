...
namespace Solar
{
    ...
    EKeyState WindowsKeyboardInput::GetState(int32_t keyCode) const
    {
        ...
        switch (action)
        {
            case GLFW_PRESS: { return EKeyState::PRESSED; break;}
            case GLFW_RELEASE: { return EKeyState::RELEASED; break;}
            case GLFW_REPEAT: { return EKeyState::HELD; break;}
            default: { return EKeyState::NONE; break;}
        }
    }
