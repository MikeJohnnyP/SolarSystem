...
namespace Solar
{
    class SOLAR_API MouseMoved : public Event
    {
    public:
    ...
    class SOLAR_API MouseButtonPressed : public MouseButtonEvent 
    {
    public:
    ...
    class SOLAR_API MouseButtonReleased : public MouseButtonEvent 
    {
    public:
    ...
    class SOLAR_API MouseScroll : public Event
    {
    public:
